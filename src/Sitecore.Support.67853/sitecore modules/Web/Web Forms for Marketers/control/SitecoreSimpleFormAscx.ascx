<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SitecoreSimpleFormAscx.ascx.cs" Inherits="Sitecore.Support.Form.Web.UI.Controls.SitecoreSimpleFormAscx" %>
